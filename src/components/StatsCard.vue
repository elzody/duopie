  ...
  <article class="stats-card">
    <div class="stats-card-item">
      <div>
        ...
        <div>
          <TextSkeleton v-if="user.streak == undefined" width="40%" height="22px" color="var(--swan)" />
    ...
    <div class="stats-card-item">
      <div>
        ...
        <div>
          <TextSkeleton v-if="user.totalXp == undefined" width="60%" height="22px" color="var(--swan)" />
    ...
    <div class="stats-card-item">
      <div>
        ...
        <div>
          <TextSkeleton v-if="user.top_three_finishes == undefined" width="30%" height="22px" color="var(--swan)" />
          <span v-else class="stats-card-item-data">{{ user.top_three_finishes }}</span>
